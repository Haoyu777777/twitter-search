...
$(document).ready(function () {
    ...
    $("#getInfo").click(function () {
        ...
        $.get("/searching_test/?" + EncodedKeyword + EndDateString + StartDateString + Count + Location,
            ...
            function (data, status) {
                ...
                if (jsObject.length != 0) {
                    ...
                    bodyString = "<center>Nothing Found 😢</center>"; // sad face, center the line
                }
...
$("#Keyword").autocomplete({
    source: function (request, response) {
        ...
        let trendWords;
        $.ajax({
            url: "/trend_in_twitter/woe_id=23424977",
            type: "GET",
            dataType: "json",
            data: {
                term: request.term
